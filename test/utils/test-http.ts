...
export class TestHttp {
    ...
    get(url: string, options?: ITestHttpRequestOptions): Promise<request.Response> {
        return new Promise((resolve, reject) => this.addRequestOptions(request(this.httpServer).get(url), options)
            .end((err, res) => err ? reject(err) : resolve(res))
        );
    }

    post(url: string, body?: string | object, options?: ITestHttpRequestOptions): Promise<request.Response> {
        return new Promise((resolve, reject) => this.addRequestOptions(request(this.httpServer).post(url), options)
            .send(body)
            .end((err, res) => err ? reject(err) : resolve(res))
        );
    }
    ...
    patch(url: string, body?: string | object, options?: ITestHttpRequestOptions): Promise<request.Response> {
        return new Promise((resolve, reject) => this.addRequestOptions(request(this.httpServer).patch(url), options)
            .send(body)
            .end((err, res) => err ? reject(err) : resolve(res))
        );
    }
    ...
    delete(url: string, options?: ITestHttpRequestOptions): Promise<request.Response> {
        return new Promise((resolve, reject) => this.addRequestOptions(request(this.httpServer).delete(url), options)
            .end((err, res) => err ? reject(err) : resolve(res))
        );
    }
